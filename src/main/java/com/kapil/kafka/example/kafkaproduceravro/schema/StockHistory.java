 ...
 */
package com.kapil.kafka.example.kafkaproduceravro.schema;
...
public class StockHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7193124726326238442L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StockHistory\",\"namespace\":\"com.kapil.kafka.example.kafkaproduceravro.schema\",\"fields\":[{\"name\":\"tradeId\",\"type\":\"int\",\"default\":-1},{\"name\":\"tradeQuantity\",\"type\":\"int\",\"default\":-1},{\"name\":\"tradeMarket\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"stockName\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"tradeType\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"price\",\"type\":\"float\",\"default\":-100.0},{\"name\":\"amount\",\"type\":\"float\",\"default\":-100.0}]}");
   ...
   */
  public static com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder newBuilder() {
    return new com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder();
  }
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder newBuilder(com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder other) {
    return new com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder(other);
  }
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder newBuilder(com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory other) {
    return new com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StockHistory>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.tradeId)) {
        this.tradeId = data().deepCopy(fields()[0].schema(), other.tradeId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder setTradeId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder clearTradeId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder setTradeQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder clearTradeQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder setTradeMarket(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder clearTradeMarket() {
      tradeMarket = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder setStockName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder clearStockName() {
      stockName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder setTradeType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder clearTradeType() {
      tradeType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder setAmount(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kapil.kafka.example.kafkaproduceravro.schema.StockHistory.Builder clearAmount() {
