...
* The original package name 'com.kapil.kafka.example.kafka-producer-avro' is invalid and this project uses 'com.kapil.kafka.example.kafkaproduceravro' instead.
